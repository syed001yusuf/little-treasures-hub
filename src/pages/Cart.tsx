...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <>
        <Helmet><title>Cart | Select Baby World</title></Helmet>
  ...
  return (
    <>
      <Helmet><title>Cart ({totalItems}) | Select Baby World</title></Helmet>
      <div className="container py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-4">
            {items.map(item => (
              <div key={item.id} className="flex items-center gap-4 bg-card rounded-2xl border p-4">
